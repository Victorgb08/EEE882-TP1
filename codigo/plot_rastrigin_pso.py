...
import numpy as np
from .rastrigin_pso import executar_pso_rastrigin
...
def plotar_convergencia_rastrigin(pc, pm):
    ...
    melhor_valor, historico = executar_pso_rastrigin(pc, pm, silencioso=True)
    ...
    plt.title('Curva de Convergência - Função Rastrigin - PSO')
    plt.xlabel('Gerações')
    ...
    caminho_arquivo = './relatorio/convergencia_rastrigin_pso.png'
