...
import numpy as np
from .rastrigin_de import executar_de_rastrigin
...
def plotar_convergencia_rastrigin(pc, pm):
    ...
    melhor_valor, historico = executar_de_rastrigin(pc, pm, silencioso=True)
    ...
    plt.title('Curva de Convergência - Função Rastrigin - DE')
    plt.xlabel('Gerações')
    ...
    caminho_arquivo = './relatorio/convergencia_rastrigin_de.png'
